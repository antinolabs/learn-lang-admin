...
function App() {
  return (
      <div className='px-2 sm:px-8 py-4'>
        <NavBar/>
        <section className='flex flex-col gap-2 mt-5 rounded-xl justify-end pb-2 sm:justify-center pr-[35%] sm:pr-[40%] md:pr-[65%] pl-[5%] h-[45vh] sm:h-[80vh] bg-[url(background_image_cutted.png)] md:bg-[url(background_image.png)] bg-cover bg-right-bottom md:bg-bottom-right'>
            <p className='font-bold text-2xl sm:text-3xl'>Learning That Doesn't Feel Like Homework</p>
            ...
            <button className='text-white px-10 py-3 border border-violet-700 hover:border-[#710cc4] rounded-xl border-b-4 w-[220px] bg-[#9515fe] mt-4 font-bold cursor-pointer hover:bg-[#710cc4]'>GET STARTED</button>
        </section>
        <div className='block sm:hidden text-center mt-8 px-2'>
          Learn something brilliant between memes, coffee , or procrastination sessions. Because smart looks good on you.
        </div>
        <Learn/>
